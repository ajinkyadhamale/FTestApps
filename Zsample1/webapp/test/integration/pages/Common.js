sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zsample1/sap/test/Zsample1/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Sample1-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Sample1-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("zsample1.sap.test.Zsample1.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zsample1/sap/test/Zsample1/localService/mockserver"], function (mockserver) {
