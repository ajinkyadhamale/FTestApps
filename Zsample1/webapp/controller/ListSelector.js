sap.ui.define([
		...
		return BaseObject.extend("zsample1.sap.test.Zsample1.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zsample1.sap.test.Zsample1.controller.ListSelector
			 */
			 ...
			 * @return {zsample1.sap.test.Zsample1.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
