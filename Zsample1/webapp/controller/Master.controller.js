/*global history */
sap.ui.define([
		"zsample1/sap/test/Zsample1/controller/BaseController",
		...
		"sap/ui/Device",
		"zsample1/sap/test/Zsample1/model/formatter",
		"zsample1/sap/test/Zsample1/model/grouper",
		"zsample1/sap/test/Zsample1/model/GroupSortState"
		...
		return BaseController.extend("zsample1.sap.test.Zsample1.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("zsample1.sap.test.Zsample1.view.ViewSettingsDialog", this);
